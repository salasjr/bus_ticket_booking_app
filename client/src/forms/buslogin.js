...
function Buslogin() {
    const [logindata, setLoginData] = useState({
      ...
      const handleLogin = () => {
        fetch('http://localhost:8000/bus/login/', {
          method: 'POST',
          headers: {
  ...
  return (
    ...
    <h1 className="text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white mt-4 mb-4">Bus Owner Login Form</h1>
